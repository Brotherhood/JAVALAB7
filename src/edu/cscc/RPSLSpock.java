...
public class RPSLSpock {
    ...
    /**
     *
     * @param pick checks the input if it is one of the correct choices
     * @return True if the input is a valid input and false if it's not
     */
    ...
    /**
     *
     * @return randomly picks one of the valid items for the computer
     */
    ...
    /**
     *
     * @param c_pick is the choice from the computer
     * @param h_pick is the input choice by the user
     * @return true if the computer wins and false if the user wins
     */
