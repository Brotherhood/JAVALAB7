...
public class RPSLSpockTest {
    ...
    /**
     * verify the method returns false if passed and invalid argument like "banana"
     */
    @Test
    public void isNotValidPick() {
        Assert.assertFalse(RPSLSpock.isValidPick("sciss"));
        Assert.assertFalse(RPSLSpock.isValidPick("banana"));
        Assert.assertFalse(RPSLSpock.isValidPick("ROKC"));
        Assert.assertFalse(RPSLSpock.isValidPick("Lizaed"));
    }
    /**
